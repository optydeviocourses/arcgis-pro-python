...
print("Preparando à camada Área CVLI para publicação ...")
...
sddraft.summary = "Camada de Área CVLI - atualizada em: " + dhProcessamento
sddraft.tags = "Hotspots, Influencias, CVLI2023"
sddraft.description = "Camada de Área CVLI - " + dhProcessamento
...
try:
    ...
    print("Publicação do Área CVLI realizada com sucesso !!!")
except:
    print(arcpy.GetMessages())
    print("Erros na publicação do Área CVLI ! Tente novamente ...")