...
cacheName = os.path.join(MyDataSourceLocal, "CACHE_RASTER_CVLI_2023")
dataSource = os.path.join(MyDataSource, "SDE.RASTER_CVLI_2023")
method = "IMPORT_SCHEME"
tilingScheme = MyTileScheme
scales = MyEscalaView
areaofinterest = "#"
maxcellsize = "#"
mincachedscale = "1500000"
maxcachedscale = "1250"
...
try:
    ...
    try:
        ...
        if arcpy.Exists(cacheName):
            arcpy.Delete_management(cacheName)
        ...
        try:
            ...
            print("Cache de Tile criando com sucesso !!!")
        except:
            print("Tentando novamente cache ...")
            try:
                arcpy.ManageTileCache_management(
                    folder, mode, cacheName, dataSource, method, tilingScheme,
                    scales, areaofinterest, maxcellsize, mincachedscale, maxcachedscale)
