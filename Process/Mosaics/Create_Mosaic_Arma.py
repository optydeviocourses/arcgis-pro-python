...
print("Iniciando criação do Mosaico de Armas ...")
...
in_local_raster_name = "RASTER_ARMA_2023"
...
try:
    arcpy.CreateMosaicDataset_management(gdbname, mdname, prjfile,
                                         noband, pixtype, pdef,
                                        wavelength)
    print("Criação do Mosaico de Armas realizada com sucesso !!!")
    print(arcpy.GetMessages())
except:
    print(arcpy.GetMessages())
    print("Erro na criação do Mosaico de Armas ! Tente novamente ...")