...
print("Iniciando Processo Local do raster de DROGAS ...")
...
local_raster_name = os.environ.get("RASTER_DROGA")
...
try:
    ...
    print("Problema no processamento local do raster de DROGAs ! Tente novamente ...")