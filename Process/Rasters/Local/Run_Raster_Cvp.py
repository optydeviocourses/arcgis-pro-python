...
print("Iniciando Processo Local do raster de CVPs ...")
...
sde_table_name = os.environ.get("VW_CAM_CVP")

local_point_table = os.environ.get("POINTS_CVP")
...
local_raster_name = os.environ.get("RASTER_CVP")
...
try:
    ...
    print("Problema no processamento local do raster de CVPs ! Tente novamente ...")