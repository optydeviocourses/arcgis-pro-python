...
print("Iniciando Processo Local do raster de ARMAS ...")
...
local_raster_name = os.environ.get("RASTER_ARMA")
...
try:
    ...
    print("Problema no processamento local do raster de Armas ! Tente novamente ...")